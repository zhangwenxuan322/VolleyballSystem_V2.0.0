            ...
            if (i == 0) {
                switch (j) {
                    case 0:
                        ...
                        break;
                    case 1:
                        label.text = [NSString stringWithFormat:@"%zd",self.duiLoss.duiKouLoss];
                        break;
                    case 2:
                        label.text = @"对手发失";
                        break;
                    case 3:
                        label.text = [NSString stringWithFormat:@"%zd",self.duiLoss.duiStartLoss];
                        break;
                    case 4:
                        label.text = @"对手犯规";
                        break;
                    case 5:
                        label.text = [NSString stringWithFormat:@"%zd",self.duiLoss.duiGui];
                        break;
                    case 6:
                        label.text = @"对手其他失";
                        break;
                    case 7:
                        label.text = [NSString stringWithFormat:@"%zd",self.duiLoss.duiElseLoss];
                        break;
                ...
                if (j == 0) {
                    ...
                    switch (i-1) {
                        case 0:
                            [self value:j-1];
                            label.text = [NSString stringWithFormat:@"%ld",self.playerModel.startGet+self.playerModel.lanGet+self.playerModel.fanKouGet+self.playerModel.firstKouGet+self.playerModel.secondGet];
                            break;
                        case 1:
                            [self value:j-1];
                        ...
                        case 3:
                            [self value:j-1];
                            label.text = [NSString stringWithFormat:@"%ld",self.playerModel.firstKouGet+self.playerModel.fanKouGet+self.playerModel.secondGet];
                            break;
                        case 4:
                            [self value:j-1];
                        ...
                        case 5:
                            [self value:j-1];
                            label.text = [NSString stringWithFormat:@"%ld",self.playerModel.lanShi+self.playerModel.fangShi];
                            break;
                        case 6:
                            [self value:j-1];
